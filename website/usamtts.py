...
rules2 = (
    b'(A)\xbd(!)=\xae(") =-AH5NKWOWT\xad(")=KWOW4T\xad(#)= NAH4MBE\xd2($)= DAA4LE\xd2(%)= PERSEH4N\xd4(&)= AEN\xc4('
    b"'"
    b')\xbd(*)= AE4STERIHS\xcb(+)= PLAH4\xd3(,)=\xac (-) =\xad(-)\xbd(.)= POYN\xd4(/)= SLAE4S\xc8(0)= ZIY4RO\xd7 (1ST)=FER4S\xd4 (10TH)=TEH4NT\xc8(1)= WAH4\xce (2ND)=SEH4KUN\xc4(2)= TUW\xb4 (3RD)=THER4\xc4(3)= THRIY\xb4(4)= FOH4\xd2 (5TH)=FIH4FT\xc8(5)= FAY4\xd6 (64) =SIH4KSTIY FOH\xd2(6)= SIH4K\xd3(7)= SEH4VU\xce (8TH)=EY4T\xc8(8)= EY4\xd4(9)= NAY4\xce(:)=\xae(;)=\xae(<)= LEH4S DHAE\xce(=)= IY4KWUL\xda(>)= GREY4TER DHAE\xce(?)=\xbf(@)= AE6\xd4(^)= KAE4RIX\xd4]\xc1'
)
